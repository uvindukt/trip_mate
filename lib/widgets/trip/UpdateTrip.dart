...
/// Implementation of [UpdateTrip] widget.
...
/// State of the [UpdateTrip] widget.
class _UpdateTripState extends State<UpdateTrip> {
  ...
  /// Shows a date picker to take user input and changes state according to that.
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: FittedBox(
                                child: Image.asset('assets/images/gif-05.gif'),
                                fit: BoxFit.fill,
                              ),
                            ),
                          ),
